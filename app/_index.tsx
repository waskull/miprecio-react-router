    ...
    <div id="home">
      ...
      <div className="flex h-screen items-center justify-center bg-white dark:bg-gray-900">
        <div className="flex flex-col items-center gap-16">
          <section className="">
            <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 lg:mb-0 mb-4">
...
const Company = (): JSX.Element => {
  return (
    <section id="company" className="bg-gray-100 dark:bg-slate-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16  lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nuestra compañia</h2>
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Marketing</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Legal</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Business Automation</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Finance</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Enterprise Design</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-700 dark:text-white">Operations</h3>
...
const FAQ = () => {
  return (
    <section id="FAQ" className="bg-zinc-50 dark:bg-gray-900">
      <div className="px-4 mx-auto max-w-screen-xl py-8 lg:py-16 lg:px-6">
  ...
  return (
    <section id="testimonials">
      ...
      <div className="mx-auto text-center">
        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nuestros clientes</h2>
        <p className="mb-8 font-light text-gray-500 lg:mb-12 sm:text-xl dark:text-gray-400">Estas son las opiniones de nuestos clientes</p>
      </div>
      <div className="grid lg:grid-cols-2">
        <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
          <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            ...
            <p className="my-4">"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi natus pariatur quibusdam obcaecati minima sint magni, dolorum quo? Esse deleniti autem aspernatur dolorum commodi, asperiores necessitatibus ratione hic. Voluptatem, facere.</p>
            <p className="my-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi dolor distinctio ut quasi adipisci. Sapiente similique odit doloremque nulla aliquid aperiam, ut assumenda eaque unde laudantium ullam dignissimos aut quod!</p>
          </blockquote>
...
function Team() {
  return (
    <section id="team" className="bg-slate-100 dark:bg-slate-900">
...
function Contact() {
  return (
    <section id="contact" className="bg-purple-50 dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="max-w-screen-lg mb-4 mt-4 text-gray-500 sm:text-lg dark:text-gray-400">
  ...
  return (
    <section className="">
      <div className="mx-auto max-w-screen-xl px-4">
        <h2 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Algunos de nuestros socios</h2>
        <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
          ...
          <a href="#" className="flex justify-center items-center">
            <svg className="h-9 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 137 37" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <footer className="p-4 bg-gray-800 md:p-8 lg:p-10 dark:bg-gray-800">
      <div className="mx-auto max-w-screen-xl text-center">
        <a href="#" className="flex justify-center items-center text-2xl font-bold text-gray-50 dark:text-white">
          <img className="mr-2 h-8" src="/favicon.ico" alt="logo" />
          MiPrecio
        </a>
        <p className="my-6 text-gray-400 dark:text-gray-400">Tu servicio de precios en la facilidad de tu mano.</p>
        <ul className="flex flex-wrap justify-center font-semibold items-center mb-6 text-gray-400 dark:text-white">
          <li>
            <a onClick={() => {
              const element = document.getElementById('home');
              element?.scrollIntoView({
