...
const Appsidebar: FC = function () {
  ...
  return (
    <Sidebar className="fixed collapse md:visible border-b border-r-1 border-gray-200 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar with multi-level dropdown example">
